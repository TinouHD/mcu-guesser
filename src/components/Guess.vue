<template>
	...
	<Popup v-show="game.winPopup" state="win" :callback="winAction" :imgToGuess="imageSource" :personToGuess="game.personToGuess"/>
	<Popup v-show="game.loosePopup" state="loose" :callback="looseAction" :imgToGuess="imageSource" :personToGuess="game.personToGuess"/>
...
export default {
	...
	mounted() {
		...
		let shouldGenerateANewPerson = this.game.personToGuess.length > 0 ? false : true
